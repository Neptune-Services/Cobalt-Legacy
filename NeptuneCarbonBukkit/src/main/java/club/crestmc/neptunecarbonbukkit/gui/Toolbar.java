...
import club.crestmc.neptunecarbonbukkit.gui.guis.CasesMain;
...
public class Toolbar {
    ...
    public void create(UnknownPlayer target, PunishmentType type, boolean bottomRow) {
        ...
        gui.setButton(4, new Button(
                ...
                () -> {
                    ...
                    new BukkitRunnable() {
                        @Override
                        public void run() {
                            FindPageGUI findPageGUI = new FindPageGUI(getGui().getPlayer(), 54, "&aFind a page.");
            ...
            gui.setButton(18, new Button(back.getItem(), () -> {
                ...
                if (getType().equalsIgnoreCase("Punishments")) {
                    new BukkitRunnable() {
                        @Override
                        public void run() {
                            CasesMain punishmentHistoryGUI = new CasesMain(getGui().getPlayer(), 9, "&2Select Type");
